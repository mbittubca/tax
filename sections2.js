...
document.body.insertAdjacentHTML('beforeend', `
    ...
    <section class="py-24 relative section-hidden">
        <div class="max-w-7xl mx-auto px-6">
            <div class="text-center mb-16">
                <span class="text-accent font-semibold tracking-wider text-sm">TESTIMONIALS</span>
                <h2 class="font-serif text-4xl lg:text-5xl font-bold mt-4 mb-6">What Our <span class="gradient-text">Clients Say</span></h2>
            </div>
            <div class="grid md:grid-cols-3 gap-8">
                <div class="glass rounded-2xl p-8 card-hover">
                    ...
                    <p class="text-gray-300 mb-6 italic">"Received a scary income tax notice for ₹12 lakhs. TaxPro handled everything professionally and got it reduced to zero. Highly recommended!"</p>
                    <div class="flex items-center gap-4">
                        <div class="w-12 h-12 bg-gradient-to-br from-accent to-gold rounded-full flex items-center justify-center text-primary font-bold">RK</div>
                        <div>
                            <div class="font-semibold">Rajesh Kumar</div>
                            <div class="text-sm text-gray-500">Business Owner, Delhi</div>
                        </div>
                    </div>
                </div>
                <div class="glass rounded-2xl p-8 card-hover">
    ...
    <!-- FAQ Section -->
    <section id="faq" class="py-24 bg-gradient-to-b from-primary via-secondary/20 to-primary section-hidden">
        <div class="max-w-4xl mx-auto px-6">
            <div class="text-center mb-16">
                <span class="text-accent font-semibold tracking-wider text-sm">FAQ</span>
                <h2 class="font-serif text-4xl lg:text-5xl font-bold mt-4 mb-6">Frequently Asked <span class="gradient-text">Questions</span></h2>
            </div>
            <div class="space-y-4" id="faqContainer">
                <div class="faq-item glass rounded-xl overflow-hidden">
                    <button class="faq-btn w-full px-6 py-5 flex items-center justify-between text-left hover:bg-white/5 transition-colors">
                        <span class="font-semibold">What should I do if I receive an Income Tax notice?</span>
                    ...
                    <div class="faq-content hidden px-6 pb-5">
                        <p class="text-gray-400">Don't panic. First, carefully read the notice to understand what information is being requested. Note the deadline for response. Then contact us immediately - we'll analyze the notice and prepare an appropriate response. Never ignore a tax notice as it can lead to penalties.</p>
                    </div>
                </div>
                <div class="faq-item glass rounded-xl overflow-hidden">
                    <button class="faq-btn w-full px-6 py-5 flex items-center justify-between text-left hover:bg-white/5 transition-colors">
    ...
    <!-- Contact Section -->
    <section id="contact" class="py-24 relative section-hidden">
        <div class="absolute inset-0 bg-gradient-to-br from-accent/5 via-transparent to-gold/5"></div>
        <div class="max-w-7xl mx-auto px-6 relative">
            <div class="grid lg:grid-cols-2 gap-16">
                <div>
                    <span class="text-accent font-semibold tracking-wider text-sm">CONTACT US</span>
                    <h2 class="font-serif text-4xl lg:text-5xl font-bold mt-4 mb-6">Get Your <span class="gradient-text">Free Consultation</span></h2>
                    <p class="text-gray-300 text-lg mb-8">Have a tax question or need professional help? Reach out to us. We respond within 2 hours on business days.</p>
                    
                    <div class="space-y-6">
                        <a href="tel:+919876543210" class="flex items-center gap-4 glass rounded-xl p-4 hover:bg-white/10 transition-colors">
                            <div class="w-14 h-14 bg-gradient-to-br from-accent/20 to-gold/20 rounded-xl flex items-center justify-center">
                                <svg class="w-6 h-6 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"/>
                                </svg>
                            </div>
                            <div>
                                <div class="text-sm text-gray-500">Call Us</div>
                                <div class="font-semibold">+91 98765 43210</div>
                            </div>
                        </a>
                        <a href="https://wa.me/919876543210" class="flex items-center gap-4 glass rounded-xl p-4 hover:bg-white/10 transition-colors">
                        ...
                        <a href="mailto:contact@taxpro.in" class="flex items-center gap-4 glass rounded-xl p-4 hover:bg-white/10 transition-colors">
                            ...
                            <div>
                                ...
                                <div class="font-semibold">contact@taxpro.in</div>
                            </div>
                        </a>
                        <div class="flex items-center gap-4 glass rounded-xl p-4">
                            <div class="w-14 h-14 bg-gradient-to-br from-purple-500/20 to-pink-500/20 rounded-xl flex items-center justify-center">
                            ...
                            <div>
                                ...
                                <div class="font-semibold">123, Legal Complex, Connaught Place, New Delhi - 110001</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="glass rounded-3xl p-8">
                    ...
                    <form id="contactForm" class="space-y-6">
                        <div>
                            ...
                            <input type="text" name="name" required class="w-full px-4 py-3 bg-white/5 border border-gray-700 rounded-xl focus:border-accent focus:outline-none transition-colors" placeholder="Your Name">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-400 mb-2">Phone Number *</label>
                            <input type="tel" name="phone" required class="w-full px-4 py-3 bg-white/5 border border-gray-700 rounded-xl focus:border-accent focus:outline-none transition-colors" placeholder="+91 98765 43210">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-400 mb-2">Email (Optional)</label>
                            <input type="email" name="email" class="w-full px-4 py-3 bg-white/5 border border-gray-700 rounded-xl focus:border-accent focus:outline-none transition-colors" placeholder="your@email.com">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-400 mb-2">How can we help? *</label>
                            <select name="service" required class="w-full px-4 py-3 bg-white/5 border border-gray-700 rounded-xl focus:border-accent focus:outline-none transition-colors">
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-400 mb-2">Brief Description</label>
                            <textarea name="message" rows="3" class="w-full px-4 py-3 bg-white/5 border border-gray-700 rounded-xl focus:border-accent focus:outline-none transition-colors resize-none" placeholder="Tell us briefly about your situation..."></textarea>
                        </div>
                        <button type="submit" class="w-full py-4 bg-gradient-to-r from-accent to-gold text-primary font-bold rounded-xl hover:shadow-lg hover:shadow-accent/30 transition-all duration-300 transform hover:scale-[1.02]">
            ...
            <div class="grid md:grid-cols-4 gap-12 mb-12">
                <div class="md:col-span-2">
                    <a href="#home" class="flex items-center gap-3 mb-6">
                        <div class="w-12 h-12 bg-gradient-to-br from-accent to-gold rounded-lg flex items-center justify-center">
                            <span class="text-primary font-bold text-xl">TP</span>
                        </div>
                        <div>
                            <span class="font-serif text-2xl font-bold">TaxPro</span>
                            <span class="block text-xs text-accent tracking-wider">ADVOCATES</span>
                        </div>
                    </a>
                    <p class="text-gray-400 mb-6 max-w-md">Expert tax advocacy services for individuals and businesses. 15+ years of experience in Income Tax, GST, and legal representation.</p>
